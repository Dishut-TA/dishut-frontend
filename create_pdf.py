...
with open(r'src\pages\StaffPDAS\PelaksanaanDanMonitoring\PenugasanPenyuluh\components\TemplateRekapPelaksanaanPDF.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
print('PDF Template created')
